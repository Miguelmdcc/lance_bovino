...
@UniqueValueAttribute(attribute = "cpf_adm", message = "Esse CPF já foi usado por outra pessoa", service = CPFUnicoService.class)
public class UsuarioAdminDTOInput {
    ...
    public static UsuarioAdminDTOInput fromUsuario(Usuario usuario) {
        UsuarioAdminDTOInput dto = new UsuarioAdminDTOInput();
        dto.setCodigo(usuario.getCodigo());
        dto.setNome(usuario.getNome());
        dto.setCpf_adm(usuario.getCpf());
    ...
    public String toString() {
        return "UsuarioDTOInput [codigo=" + codigo + ", nome=" + nome + ", cpf_adm=" + cpf_adm
